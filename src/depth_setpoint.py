...
class DepthSetpointNode():
    def __init__(self):
        ...
        #self.ysetpoint1 = 1.5
        #self.ysetpoint2 = 1.5
        #self.yawsetpoint1 = 90
        #self.yawsetpoint2 = 180
        ...
        #self.yaw_pub = rospy.Publisher("yaw_setpoint",Float64,queue_size=1)
   ...
   #     self.ycurrent = msg.pose.pose.position.y
    ...
    def get_setpoint(self):
        if self.constant:
           ...
           # print(yawerr)
            #self.yaw_pub.publish(self.yawsetpoint1)
        else:
            now = rospy.get_time()
            ...
            if i > (self.duration):
                ...
                #self.yaw_pub.publish(self.yawsetpoint2)
